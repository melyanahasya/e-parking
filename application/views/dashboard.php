...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="style/resdashboard.css"> -->
...
<body>
                ...
                <div class="row">
                    <div class="col-md-8 text-md-left text-center">
                        <ul>
                            ...
                            <li><p><i class="fa fa-envelope-o"></i>  <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="741d1a121b34031116071d00115a171b19">[email&#160;protected]</a></p></li>
                        </ul>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-lg-8 align-self-center">
                    <div class="banner-inner style-white text-center text-lg-left">
                        ...
                        <h1 class="b-animate-2 title">WE CREATING LEADERS FOR TOMORROW</h1>
            ...
            <div class="about-area-inner">
                <div class="row">
                    <div class="col-lg-6 col-md-10">
                        <div class="about-thumb-wrap after-shape" style="background-image: url('assets/img/about/2.png');">
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="emt-course-meta border-0">
                                <div class="row">
                                    ...
                                    <div class="col-2 text-right">
                                        <a class="arrow-right" href="course-details.html"><img src="assets/img/icon/5.png" alt="img"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="testimonial-area-inner bg-cover h-100"  style="background-image: url('assets/img/other/2.png');">
                        ...
                        <div class="single-testimonial-inner style-white">
                            ...
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at est id leo luctus gravida a in ipsum.</p>
                            <ul class="single-list-wrap">
                                <li class="single-list-inner style-check-box">
                                    <i class="fa fa-check"></i> Metus interdum metus
                                </li>
    ...
    <!--pricing-area start-->
    <div class="pricing-area pd-top-280 pd-bottom-90 text-center" style="background-image: url(assets/img/bg/pricing-bg.png);">
        <div class="container">
            <div class="row justify-content-center">
    ...
    <!--client-area start-->
    <div class="client-area bg-base pd-top-100 pd-bottom-100" style="background-image: url(assets/img/institute/bg.png);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
    ...
    <div class="testimonial-area pd-top-110 pd-bottom-120" style="background-image: url(assets/img/testimonial/bg.png); background-size: cover; background-position: center;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-11">
                    <div class="section-title text-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget widget_contact">
                            ...
                            <ul class="details">
                                ...
                                <li><i class="fa fa-envelope"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b6dfd8d0d998d5d9d8c2d7d5c2f6d1dbd7dfda98d5d9db">[email&#160;protected]</a></li>
